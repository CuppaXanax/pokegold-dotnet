...
1,304/1,304 tests green as of 2026-07-10, including a script-VM golden path from
New Bark bedroom to post-Red credits, source-authentic trainer/wild construction,
visible failure for missing production battle data, and stable party identity.
