...
1,353/1,353 tests green as of 2026-07-12, including a script-VM golden path from
...
source-ordered forced replacement across real multi-mon trainer battles, and
source-backed battle items with runtime PP and bag persistence coverage.
