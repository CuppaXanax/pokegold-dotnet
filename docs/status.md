...
**Current count:** 1,549 tests, 0 failures (2026-08-07).
...
| REL-003 Sprite gaps | Partial | CoverageSweepTests validates sprite/tile coverage; source palette banks and a native-host Azalea GIF are now verified. Full reachable-sprite inventory and broader captures remain. |
