...
let private makeMon hp maxHp status moves : PartyMon = { Id = System.Guid.NewGuid(); SpeciesId = 1; Nickname = "TEST"; Level = 10; Exp = 0; Hp = hp; MaxHp = maxHp; Status = status; Moves = moves; Dvs = 0; StatExp = PokeGold.Game.Battle.StatExperience.zero; Pokerus = 0; HeldItem = None; Mail = None; OtName = "PLAYER"; OtId = 0; Friendship = 70; HatchSteps = None }
