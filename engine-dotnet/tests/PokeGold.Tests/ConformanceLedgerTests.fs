    ...
    let all: LedgerEntry list =
        [
          ...
          yield! many MoveEffect ImplementedApproximate [ CriticalPathJohto; CriticalPathKanto; RequiredFor100Percent ] "Move effect is routed through explicit battle effect commands or an intentional no-op/fallback path with unit coverage for the effect family."
            [ "EFFECT_ACCURACY_DOWN"; "EFFECT_ALL_UP_HIT"; "EFFECT_ALWAYS_HIT"; "EFFECT_ATTACK_DOWN"
              "EFFECT_ATTACK_DOWN_2"; "EFFECT_ATTACK_UP"; "EFFECT_ATTACK_UP_2"; "EFFECT_ATTACK_UP_HIT"; "EFFECT_ATTRACT"
              "EFFECT_BEAT_UP"; "EFFECT_BELLY_DRUM"; "EFFECT_CONFUSE"; "EFFECT_COUNTER"; "EFFECT_CURSE"
              "EFFECT_DEFENSE_CURL"; "EFFECT_DEFENSE_DOWN"; "EFFECT_DEFENSE_DOWN_2"; "EFFECT_DEFENSE_UP"; "EFFECT_DEFENSE_UP_2"
              ...
              "EFFECT_FLY"; "EFFECT_FOCUS_ENERGY"; "EFFECT_FORESIGHT"; "EFFECT_FRUSTRATION"
              "EFFECT_FURY_CUTTER"; "EFFECT_FUTURE_SIGHT"; "EFFECT_GUST"; "EFFECT_HEAL"; "EFFECT_HEAL_BELL"; "EFFECT_HIDDEN_POWER"
              "EFFECT_JUMP_KICK"; "EFFECT_LEECH_SEED"; "EFFECT_LEVEL_DAMAGE"; "EFFECT_LIGHT_SCREEN"
              "EFFECT_LOCK_ON"; "EFFECT_MAGNITUDE"; "EFFECT_MEAN_LOOK"; "EFFECT_MIRROR_COAT"; "EFFECT_MIST"; "EFFECT_MOONLIGHT"
              "EFFECT_MORNING_SUN"; "EFFECT_MULTI_HIT"; "EFFECT_NIGHTMARE"; "EFFECT_OHKO"; "EFFECT_PAIN_SPLIT"
              "EFFECT_PAY_DAY"; "EFFECT_PERISH_SONG"; "EFFECT_POISON"
              "EFFECT_POISON_MULTI_HIT"; "EFFECT_PRESENT"; "EFFECT_PROTECT"; "EFFECT_PSYCH_UP"; "EFFECT_PSYWAVE"
              "EFFECT_RAGE"; "EFFECT_RAIN_DANCE"; "EFFECT_RAMPAGE"; "EFFECT_RAPID_SPIN"; "EFFECT_RAZOR_WIND"
              "EFFECT_REFLECT"; "EFFECT_RESET_STATS"; "EFFECT_RETURN"; "EFFECT_REVERSAL"; "EFFECT_ROLLOUT"; "EFFECT_SACRED_FIRE"
              "EFFECT_SAFEGUARD"; "EFFECT_SANDSTORM"; "EFFECT_SELFDESTRUCT"; "EFFECT_SKETCH"; "EFFECT_SKULL_BASH"; "EFFECT_SKY_ATTACK"
              "EFFECT_SLEEP_TALK"; "EFFECT_SNORE"; "EFFECT_SOLARBEAM"; "EFFECT_SP_ATK_UP"; "EFFECT_SP_DEF_UP_2"; "EFFECT_SPEED_DOWN"
              "EFFECT_SPEED_DOWN_2"; "EFFECT_SPEED_UP_2"; "EFFECT_SPIKES"; "EFFECT_SPITE"; "EFFECT_SPLASH"
              "EFFECT_STATIC_DAMAGE"; "EFFECT_STOMP"; "EFFECT_SUBSTITUTE"; "EFFECT_SUNNY_DAY"; "EFFECT_SUPER_FANG"; "EFFECT_SWAGGER"
              "EFFECT_SYNTHESIS"; "EFFECT_TELEPORT"; "EFFECT_THIEF"; "EFFECT_TOXIC"; "EFFECT_TRI_ATTACK"
