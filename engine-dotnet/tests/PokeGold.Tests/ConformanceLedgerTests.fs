        ...
        [
          ...
          yield! many MoveEffect ImplementedApproximate [ CriticalPathJohto; CriticalPathKanto; RequiredFor100Percent ] "Move effect is routed through explicit battle effect commands or an intentional no-op/fallback path with unit coverage for the effect family."
            [ "EFFECT_ALL_UP_HIT"; "EFFECT_ALWAYS_HIT"; "EFFECT_ATTACK_UP_HIT"; "EFFECT_ATTRACT"
              ...
              "EFFECT_JUMP_KICK"; "EFFECT_LEECH_SEED"; "EFFECT_LEVEL_DAMAGE"
              "EFFECT_LOCK_ON"; "EFFECT_MAGNITUDE"; "EFFECT_MEAN_LOOK"; "EFFECT_MIRROR_COAT"; "EFFECT_MOONLIGHT"
              ...
              "EFFECT_RESET_STATS"; "EFFECT_RETURN"; "EFFECT_REVERSAL"; "EFFECT_ROLLOUT"; "EFFECT_SACRED_FIRE"
              ...
              "EFFECT_STATIC_DAMAGE"; "EFFECT_STOMP"; "EFFECT_SUBSTITUTE"; "EFFECT_SUPER_FANG"; "EFFECT_SWAGGER"
